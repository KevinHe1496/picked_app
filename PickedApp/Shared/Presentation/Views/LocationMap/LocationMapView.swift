...
struct LocationMapView: View {
    ...
    @State private var region = MKCoordinateRegion(
        center: CLLocationCoordinate2D(latitude: 40.748817, longitude: -73.985428), // Latitud y longitud de la ubicación
    ...
    let annotations = [
        MyAnnotation(title: "Empire State Building", subtitle: "Famous building in NYC", coordinate: CLLocationCoordinate2D(latitude: 40.748817, longitude: -73.985428)),
